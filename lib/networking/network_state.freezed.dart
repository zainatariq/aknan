...
mixin _$NetworkState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String? message, List<String>? errorList) error,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(String? message, List<String>? errorList)? error,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class _$$ErrorImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({String? message, List<String>? errorList});
}
...
class _$ErrorImpl<T> implements _Error<T> {
  const _$ErrorImpl({this.message, final List<String>? errorList})
  ...
  @override
  String toString() {
    return 'NetworkState<$T>.error(message: $message, errorList: $errorList)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, message, const DeepCollectionEquality().hash(_errorList));
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return error?.call(message, errorList);
  }
...
abstract class _Error<T> implements NetworkState<T> {
  const factory _Error({final String? message, final List<String>? errorList}) =
      _$ErrorImpl<T>;
