...
abstract class RemoteApiAuth {
  ...
  // @MultiPart()
  Future<HttpResponse<AKnanAuthorizedResModel>> register(
    @Body() AknanRegisterReqModel req,
  );

  @POST(AuthLib.loginWithPassEndPoint)

  Future<HttpResponse<AKnanAuthorizedResModel>> loginWithPassword(
    @Body() LoginWithPassReqModel req,
  );

  @POST(AuthLib.loginWithOtpEndPoint)
  Future<HttpResponse<AKnanAuthorizedResModel>> loginWithOtp(
    @Body() LoginWithOtpReqModel req,
  );

  @POST(AuthLib.completeDataEndPoint)
  //@MultiPart()
  Future<HttpResponse<AKnanAuthorizedResModel>> completeData(
    @Body() CompleteDataReqModel req,
  );

  @POST(AuthLib.verifyPhoneEndPoint)
  // @MultiPart()
  Future<HttpResponse<AKnanAuthorizedResModel>> verifyPhone(
