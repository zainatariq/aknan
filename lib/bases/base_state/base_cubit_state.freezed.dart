...
class __$$InitialImplCopyWithImpl<T, $Res>
    extends _$ICubitStateCopyWithImpl<T, $Res, _$InitialImpl<T>>
...
class __$$LoadingImplCopyWithImpl<T, $Res>
    extends _$ICubitStateCopyWithImpl<T, $Res, _$LoadingImpl<T>>
...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$ICubitStateCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
class _$SuccessImpl<T> implements _Success<T> {
  const _$SuccessImpl({required this.uiModel});
...
abstract class _Success<T> implements ICubitState<T> {
  const factory _Success({required final T uiModel}) = _$SuccessImpl<T>;
...
class __$$ErrorImplCopyWithImpl<T, $Res>
    extends _$ICubitStateCopyWithImpl<T, $Res, _$ErrorImpl<T>>
...
class _$ErrorImpl<T> implements _Error<T> {
  const _$ErrorImpl({this.message, final List<String>? errorListMsg})
...
abstract class _Error<T> implements ICubitState<T> {
  const factory _Error(
      {final String? message,
      final List<String>? errorListMsg}) = _$ErrorImpl<T>;
